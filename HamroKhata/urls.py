...
schema_view = get_schema_view(
   openapi.Info(
      title="Hamro_Khata API",
      default_version='v1',
      description="This is Api documentation of the hamro khata",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="hamrokhata.ims@gmail.com"),
